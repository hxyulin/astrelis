...
use astrelis_window::event::{
    ElementState, ImeEvent, KeyEvent, TouchEvent, TouchId, TouchPhase, WindowEvent,
};
use astrelis_window::types::{InnerSize, OuterPosition};
...
pub(crate) fn convert_window_event(
    ...
    Some(match event {
        ...
        winit::event::WindowEvent::ThemeChanged(theme) => {
            let t = match theme {
                winit::window::Theme::Light => astrelis_window::theme::Theme::Light,
                winit::window::Theme::Dark => astrelis_window::theme::Theme::Dark,
            };
