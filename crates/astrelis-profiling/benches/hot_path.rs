...
//!
//! Verifies the claimed ~100 ns per `profile_scope!` and ~100 µs
//! per `frame_mark()` numbers.
//!
//! Run with:
//! ```sh
...
//! ```
//!
//! Record the numbers in the project plan at
//! `~/.claude/plans/effervescent-bubbling-pinwheel.md`.
//!
