...
pub struct Ui<Message = ()> {
    ...
    pub(crate) checkbox_styles: HashMap<ElementId, CheckboxStyle>,
    pub(crate) slider_styles: HashMap<ElementId, SliderStyle>,
    pub(crate) scroll_styles: HashMap<ElementId, ScrollViewStyle>,
