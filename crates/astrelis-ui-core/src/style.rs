...
impl Theme {
    ...
    pub fn dark() -> Self {
        Self {
            ...
            surface: Color::new(0.10, 0.12, 0.18, 1.0),
            foreground: Color::new(0.92, 0.94, 1.0, 1.0),
            muted_foreground: Color::new(0.58, 0.64, 0.75, 1.0),
            disabled_foreground: Color::new(0.40, 0.44, 0.52, 1.0),
            selection: Color::new(0.12, 0.38, 0.68, 0.85),
            accent: Color::new(0.25, 0.75, 1.0, 1.0),
            danger: Color::new(0.86, 0.28, 0.32, 1.0),
            success: Color::new(0.30, 0.72, 0.42, 1.0),
            warning: Color::new(0.92, 0.68, 0.24, 1.0),
            ...
            border: Color::new(0.20, 0.26, 0.38, 1.0),
            border_width: 1.5,
            radii: Radii {
                sm: 3.0,
                md: 6.0,
